...
$(function(){
    ...
    //查询全部证书
             ...
             // console.log(data[i].stats)
                if(data[i].status!="disabled"){
                   ...
                   table.row.add([
                                ...
                                data[i].phone,
                                "<button class='btn-sm btn_info' data="+i+">吊销证书</button>",
      ...
      //吊销证书
      $("#table_id_example").on("click","button.btn-sm",function(){
    ...
    //选择城市
      var province={"BeiJing":"北京市","ShangHai":"上海市","ZheJiang":"浙江省","FuJian":"福建省","HuNan":"湖南省","GuangDong":"广东省",
      ...
      var ZheJiang={"HangZhou":"杭州市","WenZhou":"温州市","NingBo":"宁波市","TaiZhou":"台州市","JiaXing":"嘉兴市","JinHua":"金华市","HuZhou":"湖州市",
