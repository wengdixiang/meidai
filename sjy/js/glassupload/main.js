(function(){'use strict';
  ...
  require(['js/glassupload/headloader','js/glassupload/glassloader','js/glassupload/display','js/glassupload/slidereffect','js/glassupload/scrolleffect','js/glassupload/cookie','js/glassupload/framedesign','js/glassupload/legdesign','js/glassupload/color','js/glassupload/fileurlgenerator','js/glassupload/progress','js/glassupload/batchupload'],function(headloader,glassloader,display,slidereffect,scrolleffect,cookie,framedesign,legdesign,color,fileurlgenerator,progress,batchupload){
    ...
    var minInterfaceWidth=433,
        ...
        loginUrl="./login.html?returnUrl=glassupload.html",
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            //startDownload();
              ...
              batchupload.startUpload(orderUuid);
          },
          error: function(err) {
            alert("请求用户数据错误："+err);
            location.href=loginUrl;
