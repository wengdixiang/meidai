(function () {
  ...
  require(['js/glassadjust/headloader', 'js/glassadjust/glassloader', 'js/glassadjust/display', 'js/glassadjust/slidereffect', 'js/glassadjust/scrolleffect', 'js/glassadjust/cookie', 'js/glassadjust/framedesign', 'js/glassadjust/legdesign', 'js/glassadjust/color', 'js/glassadjust/fileurlgenerator', 'js/glassadjust/progress'], function (headloader, glassloader, display, slidereffect, scrolleffect, cookie, framedesign, legdesign, color, fileurlgenerator, progress) {
    ...
    function startLogin() {
      ...
      orderUuid = cookie.getCookie("UserUUID");
