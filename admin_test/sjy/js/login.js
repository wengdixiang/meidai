...
function goTohtml(){
  ...
  for(;i<len;++i){
    var index1=searchitems[i].indexOf("returnUrl=");
    var index2=searchitems[i].indexOf(".html");
    if(index1>=0&&index2>=0){
      var urlstart=index1+10,
          urllength=index2+5-index1;
      url=searchitems[i].slice(urlstart,urllength);
      break;
    }
  }
